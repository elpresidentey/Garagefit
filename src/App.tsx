      ...
      <header className="topbar">
        <div className="wrap topbar-in">
          ...
          <div className="top-actions">
            ...
            <a className="home-link" href="#/" aria-label="Back to the landing page" onClick={(e) => { e.preventDefault(); if (location.hash !== '#/') location.hash = '#/'; else window.scrollTo({ top: 0, behavior: 'smooth' }); }}>Home</a>
